...
public class ProductDAO {
	...
	// 전체 제품 출력(SELECT ALL)
	final String SELECT_ALL = "SELECT P_NUM, P_NAME, P_PRICE, P_INFO, P_FINISH, P_IMAGE, P_AMOUNT, P_CRNAMOUNT FROM PRODUCT";
	// 제품 하나 출력(SELECT ONE)
	final String SELECT_ONE = "SELECT P_NUM, P_NAME, P_PRICE, P_INFO, P_FINISH, P_IMAGE, P_AMOUNT, P_CRNAMOUNT FROM PRODUCT WHERE P_NUM=?";
	// 제품 구매 시 펀딩 금액 상승
