...
<body>
	...
	<form action="#" class="checkout__form"
		...
		<h5
			style="font-weight: 700; font-size: 25px; font-family: 'Noto Sans'; margin-top: 50px; margin-left: 5%; margin-bottom: 10px; border-bottom: white; display: unset;">약관동의</h5>
		...
		<div class="regi_wrap" style="float: right; margin-right: 5%;">


			<label for="chk_all"
				style="font-weight: 400; margin-bottom: 0px; margin-top: 10px;">위
				항목에 모두 동의합니다.</label> <input type="checkbox" id="cbx_chkAll" value="1"
				id="chk_all" style="width: 16px; height: 16px;">
		</div>

		<section id="fregister_term">

			<textarea readonly
				style="width: 90%; display: inline-block; margin-left: 5%; border-radius: 15px; border: 1px solid rgb(217, 217, 217); overflow-y: hidden; height: 220px; margin-top: 30px;">제 1 장 총칙
제1조(목적)
...
2. 한국생산성본부는 사정상 혹은 영업상 중요한 사유가 발생될 경우에는 약관의 규제 등에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진 등에 관한 법률, 방문판매 등에 관한 법률, 소비자보호법 등 관련법을 위배 하지 않은 범위에서 이 약관을 개정할 수 있습니다.
			...
			<fieldset class="fregister_agree"
				...
				<label for="agree11" style="margin-top: 10px; font-weight: 400;">위
					항목에 동의합니다.</label> <input type="checkbox" name="chk" value="1" id="agree11"
		...
		<section id="fregister_private">
			...
			<textarea readonly
				style="width: 90%; display: inline-block; margin-left: 5%; border-radius: 15px; border: 1px solid #D9D9D9; overflow-y: hidden; height: 220px; margin-top: 20px;">제 1 장 총칙
제1조(목적)
1. 이 약관은 한국생산성본부가 제공하는 한국생산성본부 사업 관련 서비스(이하 서비스라 합니다)를 이용함에 있어 이용조건 및 절차와 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
제2조(약관의 효력과 변경)
1. 본 약관은 그 내용을 서비스 화면에 게시하고 이용자가 서비스화면에서 동의 의사표시를 함으로써 효력을 발생합니다.
2. 한국생산성본부는 사정상 혹은 영업상 중요한 사유가 발생될 경우에는 약관의 규제 등에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진 등에 관한 법률, 방문판매 등에 관한 법률, 소비자보호법 등 관련법을 위배 하지 않은 범위에서 이 약관을 개정할 수 있습니다.
			...
			<fieldset class="fregister_agree"
				...
				<label for="agree21" style="margin-top: 20px; font-weight: 400;">위
					항목에 동의합니다.</label> <input type="checkbox" name="chk" value="1" id="agree21"
					style="width: 16px; height: 16px;">
			</fieldset>
		</section>
		<div class="button_next">
			<input type="submit" class="site-btn" value="1" id="cbx_chkAll"
				value="1" id="chk_all"
