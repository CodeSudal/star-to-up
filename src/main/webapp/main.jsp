...
<body>
	<a href="./index.html"><img src="img/logo.png" alt=""
		style="position: absolute; z-index: 3; width: 250px; margin-top: 20px; margin-left: 30px;" /></a>
	<ul id="menu-ul">
		<li><a href="store.do" style="font-weight: 600;"">STORE</a></li>
		<li><a href="info.do" style="font-weight: 600;">INFO</a></li>
		<li><a href="about.do" style="font-weight: 600;">ABOUT</a></li>
	</ul>
	...
	<div id="wrapDiv">
		...
		<section id="wrapper-media" class=""
			style="position: relative; z-index: 1;"></section>
		<!-- Section: Media -->
		<div class="col-md-4 mb-4 mb-md-0" style="display: none;">
			<!-- Section: Description -->
			<section class="">
				<h5 id="wrapper-title" style="display: none;"></h5>
				<p class="text-muted mb-2" style="display: none;">
					<span id="wrapper-copyright" style="display: none;"></span>
				</p>
	...
	<div class="container my-5">
		...
		<section class="mb-4">
			...
			<!-- <div
                    ...
                    > -->
			<!-- id="wrapper-date" -->
			<input type="text" id="wrapper-date" value="" style="display: none" />
		</section>
	</div>
	<!-- Section: Date -->
